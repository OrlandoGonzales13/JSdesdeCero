...
// Cuando se llama a house.dogGreeting(), this en la función hace referencia al objeto house, ya que es el objeto que contiene y llama al método. 
...
newDogGreeting.call(newHouse, owner, address);// Salida: Hi, my name is Scannor and my owner is Beder and I live in Calle 123
