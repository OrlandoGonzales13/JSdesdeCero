...
// Así que, entender los diferentes tipos de “binding” es esencial para comprender cómo se comporta this en diferentes situaciones. 
// Veamos los cinco tipos principales de “binding”:
    ...
    // New Binding:
        ...
        const adam2 = new Person('Adam');
        console.log(adam2.name); // Output: Adam


// Lexical Binding:
        // Ocurre cuando se utiliza this en una función dentro de otra función. 
        // En este caso, this se vincula al contexto léxico de la función exterior.
...
// Window Binding:
        // Ocurre cuando ninguna de las reglas anteriores se aplica y this se vincula al objeto global 
        // (por ejemplo, window en el navegador).
